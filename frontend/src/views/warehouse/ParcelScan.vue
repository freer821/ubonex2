  ...
  <div style="padding:10px">
    <el-row :gutter="20">
      <el-col :span="14">
        ...
        >
          ...
          <el-form-item v-if="scan_type == 'manual'">
            ...
            <input v-model="main_plate_code" type="text" class="ps_input" />
          </el-form-item>
          <el-form-item>
      ...
      <el-col :span="10">
        ...
        <div class="ps_big_pici">
          <span ref="pici_code_result">{{
            scan_type === "auto"
              ? package_response.pici_code
              : package_response.main_plate_code
          }}</span>
        </div>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="10">
        <div
          class="ps_status"
          v-if="package_response.status"
          ref="package_status_result"
        >
          <span>{{ package_response.status }}</span>
        </div>
        <div class="ps_status" ref="package_status_result" v-else>
          <span>等待扫描</span>
        </div>
      </el-col>
      <el-col :span="7">
...
export default {
  ...
  methods: {
        ...
        .then(response => {
          ...
          switch (this.package_response.status_no) {
            case "41":
              ...
              this.scan_result_successed =
                parseInt(this.scan_result_successed) + 1;
              break;
            case "43":
    ...
    changeBackgroundColor() {
      if (
        this.package_response &&
        (this.package_response.status_no === "41" ||
          this.package_response.status_no === "43")
      ) {
